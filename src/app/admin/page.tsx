  ...
  return (
    <div>
      ...
      <section className="mt-7 overflow-hidden rounded-2xl border border-line bg-surface/75">
        <div className="flex items-center justify-between border-b border-line px-5 py-4"><div><h2 className="font-display text-2xl">Jugadores</h2><p className="mt-1 text-xs text-muted">Los nuevos registros aparecen aquí automáticamente.</p></div><Badge tone="green">Registro abierto</Badge></div>
